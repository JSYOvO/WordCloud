...
class Texts extends React.Component {
    ...
    handleSubmit = () => {
        ...
        if(!text.textName && !text.textContent) return;
        this._post(text);
    }
        ...
        return (
            <div>
                ...
                <Dialog open={this.state.dialog} onClose = {this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label = "텍스트 이름" type = "text" name = "textName" value = {this.state.textName} onChange = {this.handelValueChange} />
                        <br/><br/>
                        <input className = {classes.hidden} accept="text/plain" id = "raised-button-file" type = "file" value = {this.state.fileName} onChange = {this.handleFileChange} />
                        <label htmlFor = "raised-button-file">
                            <Button variant = "contained" color = "primary" component = "span" name = "file">
                                {this.state.fileName === "" ? ".txt 파일을 선택" : this.state.fileName}
                            </Button>
                        </label>
                        <TextTruncate
                            line = {1}
